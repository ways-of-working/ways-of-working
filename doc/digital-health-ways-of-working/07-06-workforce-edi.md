...
This chapter is about the workforce — your colleagues, recruits and leaders — and is deliberately distinct from the user-facing concerns of Chapter 1.9 — Digital Inclusion & Accessibility. The two are joined: an inclusive workforce is one of your strongest defences against inequitable services. Treat this alongside Chapter 7.0 — Team Structures, Roles & Responsibilities, Chapter 7.3 — Workforce Strategy, and Chapter 7.5 — People & Organizational Development.
...
5. **Whose disadvantage does our data hide because we only ever look at one characteristic at a time?**
   Most monitoring counts race, sex and disability on separate axes, which is exactly how the groups facing the sharpest, compounded disadvantage stay invisible — a disabled woman of colour is not the average of three separate gaps, and single-axis dashboards will never show her. In a digital, data and technology function the numbers in any one intersectional cell are often small, which is both a genuine statistical difficulty and a convenient reason never to look. The trade-off to debate is rigour and anonymity versus visibility: cutting data too finely risks identifying individuals and breaching confidence, yet refusing to cut it at all guarantees you miss the people the standards exist to protect. Pair the quantitative limits with lived experience gathered safely, so that where the cell is too small to report, the story is not simply lost. A strong answer commits to examining intersectional patterns wherever numbers responsibly allow, is candid about where they cannot, and resists treating a headline WRES or WDES figure as the whole picture when it may be averaging away the worst-affected.
