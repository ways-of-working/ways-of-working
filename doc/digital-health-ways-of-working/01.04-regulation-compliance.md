# Chapter 1.4 — Regulation & Compliance Landscape
...
Finally, this is public money and statutory duty. When you deploy a non-compliant system you are not just exposing your organisation to enforcement; you may be breaching duties owed to patients and citizens, and spending public funds on something you cannot lawfully run. That is why this chapter frames the more detailed chapters that follow on clinical safety (Chapter 1.5 — Clinical Safety & Risk Management), information governance (Chapter 1.6 — Information Governance, Data Protection & Cyber Security), data ethics (Chapter 1.7 — Data Ethics, Consent & Public Trust), and assurance (Chapter 6.4 — Governance & Assurance). This chapter is the navigator; those are the detailed charts.
