...
8. **Make security architecture and secure-by-design non-negotiable.** Bring security thinking into design from the first sketch, not as a pre-launch gate: minimise the attack surface, apply least privilege, segment networks, and assume components will be probed. In health and care this is inseparable from clinical safety and information governance (Chapter 1.6 — Clinical Safety & Risk Management; Chapter 1.7 — Information Governance, Data Protection & Cyber Security), because a breach is both a data harm and, when it stops systems, a patient-safety event. Unsupported, unpatchable software is a security decision you are making by default — so make it deliberately, with mitigations, or not at all.
