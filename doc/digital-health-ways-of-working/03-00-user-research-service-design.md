...
4. **Are we researching the whole service, or just the part we happen to own?** Most of the harm and frustration patients experience is manufactured in the seams — between the letter and the phone line, between primary and secondary care, between the digital front door and the human who has to re-key what it captured. Ask honestly how far your research reaches: does it stop at the edge of your screen, or does it follow the person into the waiting room, the call centre, and the back-stage work of the staff who prop the service up? Discuss whether you have actually shadowed the receptionists, booking clerks, and nurses whose workarounds keep the pathway alive, because their invisible labour is usually where the real design problem sits. Be wary of a comfortable scope that matches your team's remit rather than the patient's journey, since organizational boundaries are exactly where accountability evaporates. An honest answer names the parts of the journey you cannot see and commits to a service blueprint that makes the back-stage visible, even when it implicates systems you do not control. Scoping out the seams is how a screen redesign ends up solving nothing.
