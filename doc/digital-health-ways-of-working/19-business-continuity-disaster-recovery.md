# Chapter 19 — Business Continuity & Disaster Recovery
...
This chapter extends the operational discipline of Chapter 18 — Service Management & Live Operations, but shifts the focus from everyday running to major disruption: the fire, flood, cyber-attack, supplier collapse, or regional outage that threatens to take a critical service down for hours or days. It connects tightly to Chapter 6 — Information Governance, Data Protection & Cyber Security (because ransomware recovery is now a central continuity scenario), to Chapter 20 — Technical Architecture, Cloud & Legacy (because resilience is designed in, not bolted on), and to Chapter 31 — Governance & Assurance (because someone must own, test, and be accountable for the plan). Get this right and disruption becomes a bad day; get it wrong and it becomes a public inquiry.
