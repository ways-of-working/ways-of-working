...
8. **Align teams through strategy, not micromanagement.** Autonomy without alignment produces local optimisation and chaos. A clear product vision and strategy — and, at scale, a portfolio and programme frame (Chapters 5.2 and 5.3) — is what lets you empower teams safely.
...
- **Applying product-led to genuinely finite work.** A one-off data-centre migration or a hardware rollout does not need a perpetual team. Fix: use project-led work (Chapter 5.1) where scope really is fixed.
