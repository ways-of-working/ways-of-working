...
**Intake** is the disciplined process of receiving, recording, classifying, and acknowledging every unit of demand before any decision is made about whether or how to do it. It is deliberately separate from triage (assessing and routing — Chapter 12) and prioritisation (ordering — Chapter 13). Intake's only job is to make demand *visible and comparable*.
