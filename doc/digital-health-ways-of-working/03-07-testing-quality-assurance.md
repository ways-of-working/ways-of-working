...
Every digital service carries defects; the only questions are how many, how serious, and whether you find them before or after a patient is affected. In a consumer app an undetected bug wastes a user's afternoon. In a clinical system it can display the wrong patient's allergies, round a paediatric drug dose incorrectly, or silently drop a referral into a queue no one monitors. Testing is the organized effort to find those defects early, and quality assurance is the wider system of controls that keeps quality from depending on luck or heroics.
