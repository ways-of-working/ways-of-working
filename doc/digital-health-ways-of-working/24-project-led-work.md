...
The danger is using this tool for the wrong job. Project-led governance applied to an evolving digital service produces the "build it and abandon it" pathology described in Chapter 23 — Product-Led Work. This chapter explains where project-led work is the right instrument, and where its limits begin. It sits alongside Chapter 25 — Programme-Led Work, which coordinates multiple projects, and Chapter 26 — Enterprise Portfolio & Project Management (EPPM), which chooses between these tools.
...
- **Project-managing an evolving service.** Applying fixed-scope, disband-at-the-end governance to a living digital product produces the abandonment pathology. Fix: use product-led work (Chapter 23) where the service is ongoing.
