...
9. `## Maturity model` — a 4-level table (Initial / Developing / Defined / Optimizing) with 3–5 rows of observable characteristics.
...
- Cross-reference sibling chapters by number and title, e.g. "(see Chapter 29 — Change Management)". The canonical chapter numbering lives in `spec/index.md` §4 — check it before citing a number.
