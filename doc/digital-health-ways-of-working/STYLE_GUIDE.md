...
- Cross-reference sibling chapters by number and title, e.g. "(see Chapter 38 — Change Management)". The canonical chapter numbering lives in `spec/index.md` §4 — check it before citing a number.
