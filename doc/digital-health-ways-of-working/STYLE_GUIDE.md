...
- Cross-reference sibling chapters by number and title, e.g. "(see Chapter 45 — Change Management)". The canonical chapter numbering lives in `spec/index.md` §4 — check it before citing a number.
