# Chapter 33 — Enterprise Resource Planning (ERP)
...
4. **Run ERP replacement as a major programme, with change management at its core.** An ERP implementation is a business-change programme that happens to involve software, not an IT project. Resource it with programme discipline (see Chapter 31 — Programme Management) and a genuine [change-management](https://en.wikipedia.org/wiki/Change_management) effort (see Chapter 46 — Change Management), because most ERP pain is people and process, not technology.
...
- **ERP run as an IT project.** Treating it as a technology swap starves the change, training, and process-redesign effort. Fix: run it as a business-change programme with real change management (Chapter 46).
...
- [ ] Change management, training, and process redesign are explicitly resourced (see Chapter 46).
...
- See also Chapter 31 — Programme Management, Chapter 32 — Enterprise Project Portfolio Management, and Chapter 46 — Change Management.
